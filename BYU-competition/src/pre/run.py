...
class ByuProcessor():
    def __init__(
        self, 
        in_dir: str = "/argusdata4/naamagav/byu/train/", 
        out_dir: str = "/argusdata4/naamagav/byu/processed/", 
    ):
        super().__init__()
        self.in_dir = in_dir
...
if __name__ == "__main__":
    ...
    # Load folds
    df= pd.read_csv("/argusdata4/naamagav/byu/processed/folds_all.csv")
    ...
    # Process
    p= ByuProcessor(
        in_dir = "/argusdata4/naamagav/byu/train/", 
        out_dir = "/argusdata4/naamagav/byu/processed/",
        )
    p.run(df=df.copy())
